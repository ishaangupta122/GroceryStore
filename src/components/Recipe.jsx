...
const Recipe = () => {
  const [recipe, setRecipe] = useState([
    {
      id: 1,
      imgUrl: "./src/assets/receipe-img1.jpg",
    ...
    {
      id: 2,
      imgUrl: "./src/assets/receipe-img2.jpg",
    ...
    {
      id: 3,
      imgUrl: "./src/assets/receipe-img3.jpg",
  ...
  const [recipeBook, setRecipeBook] = useState([
    {
      id: 1,
      imgUrl: "./src/assets/receipe-img4.jpg",
      bookName: "Cookbook",
          ...
          <div className="rec-container">
            <div className="rec-container1">
              {recipe.map((item, index) => (
                <Link className="rec-link" key={item.id}>
            ...
            <div className="rec-main-container2">
              <div className="rec-container2">
                {recipeBook.map((item, index) => (
                  <div className="rec-desc2" key={item.id}>
